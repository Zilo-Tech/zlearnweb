...
export default function StudyPlanPage() {
    return (
        <div className="space-y-6 pb-8 text-base antialiased">
            <div>
                <p className="text-sm font-bold text-primary-600 uppercase tracking-widest mb-1">Planning</p>
                <h1 className="text-3xl font-black text-primary-900 tracking-tight">Study Plan</h1>
                <p className="text-gray-600 mt-2 max-w-xl">
                    Schedule and track your study goals. This page is being brought in line with the mobile app.
                </p>
            </div>
            <div className="rounded-2xl border-2 border-primary-200 bg-white p-8 md:p-12 text-center">
                ...
                <p className="text-gray-600 max-w-md mx-auto mb-6">
                    Study plan is available on the Z-Learn mobile app. We&apos;re adding it here next.
                </p>
